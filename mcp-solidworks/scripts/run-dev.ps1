param(
    [string]$EnvFile = (Join-Path $PSScriptRoot '..\config\solidworks.env'),
    [int]$Port = 42197
)
...
Write-Host "mcp-solidworks dev server"
...
dotnet run --project (Join-Path $PSScriptRoot '..\src\McpSolidWorks.csproj')
