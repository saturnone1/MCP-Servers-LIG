param(
    [string]$TargetRunScript = (Join-Path $PSScriptRoot '..\publish\mcp-solidworks-win-x64\run.ps1'),
    [string]$ShortcutPath = (Join-Path ([Environment]::GetFolderPath('Desktop')) 'mcp-solidworks.lnk')
)
