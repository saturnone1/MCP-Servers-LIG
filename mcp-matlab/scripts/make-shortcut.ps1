param(
    [string]$TargetRunScript = (Join-Path $PSScriptRoot '..\publish\mcp-matlab-win-x64\run.ps1'),
    [string]$ShortcutPath = (Join-Path ([Environment]::GetFolderPath('Desktop')) 'mcp-matlab.lnk')
)
